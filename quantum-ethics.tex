...
\usepackage[pdftex,pdfauthor=Sébastien\ Fauvel,pdftitle=Quantum\ Ethics:\ A\ Spinozist\ Interpretation\ of\ Constructive\ Quantum\ Field\ Theory\ on\ the\ Lattice]{hyperref}
\usepackage{appendix}
%\usepackage{makeidx}
\usepackage{latexsym}
\usepackage{amssymb}
