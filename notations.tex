...
% Mental notations
\newcommand{\CMS}{\mathcal M} % Set of all mental states
\newcommand{\ims}{\mathfrak{m}} % Placeholder subjective experience
\newcommand{\cms}{\mathfrak{M}} % Placeholder mental state
\newcommand{\bM}[2]{{#1}_{#2}} % Mental state indices
\newcommand{\bFM}[2]{({#1}_{#2})} % Mental field indices

% Pantheist notations
\newcommand{\God}{\mathfrak{g}} % God = Substance
\newcommand{\GodState}[2]{\left({#1},{#2}\right)} % State of God = Mode of the Substance
