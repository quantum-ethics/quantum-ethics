...
\paragraphtitle{§} Let $(\ket {\Psi_i})$ be an orthonormal basis of the subspace $\H_{\CMS_0}^{\infty \perp}$. The partial trace of the operator $\op P_{\CMS_0}^{(t)}$ on this subspace is given, for any $t \in \IN$, by:
\begin{equation*}
