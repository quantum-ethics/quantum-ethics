...
\end{equation*}
Let us write $\H_{\CMS_0}^\infty$ their intersection and $\H_{\CMS_0}^{\infty \perp}$ its supplementary subspace in $\H_{\CMS_0}$.
...
\paragraphtitle{Theorem} An initial mental state $\cms_i \in \CMS$ being given, for any initial quantum state $\ket \Psi \in \H_{\cms_i}$, the probability that the mental state $\cms_i$ be experienced again in the future equals 1.
