...
\paragraphtitle{Lemma 1} For any mental state $\cms \in \CMS$ and any quantum state $\ket \Psi \in \H$ orthogonal to $\H_{\CMS_0}^\infty$, the quantum states $\op \Pi_\cms \ket \Psi$ and $\op U_\tau \op \Pi_\cms \ket \Psi$ are orthogonal to $\H_{\CMS_0}^\infty$, too.

\paragraphtitle{Lemma 2} The sequence of operators $(\op P_{\CMS_0}^{(n)})$ converges towards $\op \Pi_{\H_{\CMS_0}^\infty}$.
