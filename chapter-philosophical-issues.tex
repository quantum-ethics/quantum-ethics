...
\end{equation*}
isn't reduced to the zero subspace. We will consider the endomorphism $U_\cms$ induced by $U_\tau$ on $\H_\cms$, given by:
\begin{equation*}
U_\cms \eqdef \op \Pi_\cms U_\tau \op \Pi_\cms
\end{equation*}
...
\begin{equation*}
\mathrm P_t(\cms, \dotsc, \cms; \ket{\Psi}) = \bra{\Psi} \op \Pi_{\H_\cms^\infty} \ket{\Psi} / \braket{\Psi}{\Psi} + \bra{\Psi} \op \Pi_{\H_\cms^{\infty \perp}} \ket{\Psi} / \braket{\Psi}{\Psi} \mathrm P_t(\cms, \dotsc, \cms; \op \Pi_{\H_\cms^{\infty \perp}} \ket{\Psi})
\end{equation*}
...
\end{equation*}
Any eventually dying sequence is therefore infinitely improbable, \textit{QED}.
