...
\paragraphtitle{Lemma 1} For any mental state $\cms \in \CMS$ and any quantum state $\ket \Psi \in \H$ orthogonal to $\H_{\CMS_0}^\infty$, the quantum state $\op U_\tau \op \Pi_\cms \ket \Psi$ is orthogonal to $\H_{\CMS_0}^\infty$, too.
